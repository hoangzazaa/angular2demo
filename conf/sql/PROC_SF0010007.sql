DROP PROCEDURE IF EXISTS PROC_SF0010007;

DELIMITER ;;
CREATE DEFINER=`sgsk_production`@`%` PROCEDURE `PROC_SF0010007`(IN picId VARCHAR(20), IN startDate VARCHAR(20), IN endDate VARCHAR(20))
  BEGIN
