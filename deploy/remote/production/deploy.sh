...
# プロセスを立ち上げる
nohup ${root_dir}/${target_dir}/bin/sefuri_salesfront -Dhttp.port=9000 -Dhttps.port=9001 -J-Xms300M -J-Xmx2G -Dthumbnailator.conserveMemoryWorkaround=true > "${root_dir}/${log_name}" &
