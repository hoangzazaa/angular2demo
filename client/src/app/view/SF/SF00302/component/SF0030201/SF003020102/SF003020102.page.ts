...
import {SF003020102Helper} from "./SF003020102.helper";
...
export class SF003020102Page extends AbstractSF00302Page<SF003020102Helper> implements AfterViewInit, OnInit {
    // create constructor
    constructor(route: ActivatedRoute, router: Router, headerProvider: HeaderProvider, public sv00302Service: SF00302Service) {
        ...
        this.helper = new SF003020102Helper;
    ...
    private parseDataPaper(sf00302Data: any) {
        // get list mst paper
        let mstLamination = sf00302Data["mstLamination"];
        let mstLaminationHead = sf00302Data["mstLaminationHead"];
        ...
        if (this.isCreat) {
            ...
            this.sv00302Service
                ...
                .then(data => {
                    ...
                    this.router
                        .navigate(['/home/deal', dealCode, 'product', productCode, 'decorative'], {replaceUrl: true})
                        .then(res => {
    ...
    protected doDuplicateProduct(type: number): void {
        ...
        this.sv00302Service
            ...
            .then(data => {
                let productCode = data.dealProduct.product.productCode;
                this.router
                    .navigate(['/home/deal', this.pageData.dealCode, 'product', productCode,'decorative'])
                    .then(res => {
    ...
    private assignMstDatas(data: any) {
        ...
        data["mstColor"].forEach((color) => {
            if(color["productType"]==0) {
                ...
                DataUtil.pushData(mstColorFlexo, color["basicCost"], "basicCost", color["colorOption"],color["throughNumber"]);
                DataUtil.pushData(mstColorFlexo, color["throughWage"], "throughWage", color["colorOption"],color["throughNumber"]);
            }
        });
