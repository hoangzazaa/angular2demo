...
import {SF003020103Helper} from "./SF003020103.helper";
...
export class SF003020103Page extends AbstractSF00302Page<SF003020103Helper> {
    ...
    constructor(route: ActivatedRoute, router: Router, headerProvider: HeaderProvider, public sv00302Service: SF00302Service) {
        ...
        this.helper                                 = new SF003020103Helper();
        ...
        if (this.isCreat) {
            ...
            this.sv00302Service
                ...
                .then(data => {
                    ...
                    this.router
                        .navigate(['/home/deal', dealCode, 'product', productCode, 'one-stage'], {replaceUrl: true})
                        .then(res => {
    ...
    protected doDuplicateProduct(type: number): void {
        ...
        this.sv00302Service
            ...
            .then(data => {
                let productCode = data.dealProduct.product.productCode;
                this.router
                    .navigate(['/home/deal', this.pageData.dealCode, 'product', productCode,'one-stage'])
                    .then(res => {
