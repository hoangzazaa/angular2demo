...
var SF003020201_helper_1 = require("./SF003020201.helper");
 ...
 * 製品情報(段ボール)
 */
var SF003020201Page = (function (_super) {
    __extends(SF003020201Page, _super);
    // create constructor
    function SF003020201Page(route, router, headerProvider, sv00302Service) {
        _super.call(this, router, route, headerProvider);
        this.sv00302Service = sv00302Service;
        this.checkValidateBorder = false;
        this.helper = new SF003020201_helper_1.SF003020201Helper;
        this.helper.sf00302Data = new SF00302_data_1.SF00302Data;
        this.helper.sf00302Data.product.productType = 1;
    }
    SF003020201Page.prototype.initBreadcrumb = function () {
        var self = this;
    ...
    SF003020201Page.prototype.ngAfterViewInit = function () {
    ...
    Object.defineProperty(SF003020201Page.prototype, "pageData", {
        get: function () {
    ...
    SF003020201Page.prototype.ngOnInit = function () {
    ...
    SF003020201Page.prototype.initDataScreen = function (dealCode, dataDeal, sf00302Data) {
    ...
    SF003020201Page.prototype.parseDataPaper = function (sf00302Data) {
        // get list mst paper
    ...
    SF003020201Page.prototype.addMstLamination = function (laminations, laminationsHead) {
        //3.parse mstPapers
        if (!!laminations) {
    ...
    SF003020201Page.prototype.assignDealProduct = function (source) {
    ...
    SF003020201Page.prototype.refeshIndexingObjects = function () {
    ...
    Object.defineProperty(SF003020201Page.prototype, "isView", {
        get: function () {
    ...
    Object.defineProperty(SF003020201Page.prototype, "isCreat", {
        get: function () {
    ...
    Object.defineProperty(SF003020201Page.prototype, "hasProduct", {
    ...
    SF003020201Page.prototype.isTemplateDeal = function (deal) {
        return deal.isTemplate || (!this.isCreat && this.pageData.deal.dealStatus >= 4);
    };
    /** @inheritDoc */
    SF003020201Page.prototype.doSaveProduct = function () {
        var _this = this;
        ...
        if (this.isCreat) {
            ...
            this.sv00302Service
                ...
                _this.router
                    .navigate(['/home/deal', dealCode_1, 'product', productCode, 'carton'], { replaceUrl: true })
                    .then(function (res) {
            ...
            if (this.pageData.checkInputSave) {
                this.sv00302Service.sv003012UpdateProductInput(product, this.pageData.paperModelNews).then(function (data) {
                    ...
                    _this.checkValidateBorder = true;
                    _this.helper.checkProcessCase();
    ...
    /** @inheritDoc */
    SF003020201Page.prototype.doDuplicateProduct = function (type) {
        var _this = this;
        var isShowMessage = false;
        if (this.pageData.product.memo1 != undefined && eastasianwidth_1.Eastasianwidth.numberLength(this.pageData.product.memo1) > 60 && this.pageData.checkInputSave) {
            isShowMessage = true;
        ...
        this.sv00302Service
            ...
            var productCode = data.dealProduct.product.productCode;
            _this.router
                .navigate(['/home/deal', _this.pageData.dealCode, 'product', productCode, 'carton'])
                .then(function (res) {
    ...
    /*Cancel product*/
    SF003020201Page.prototype.cancelProduct = function () {
        var message = "";
        var check = false;
        this.helper.checkChangeDataProduct();
    ...
    SF003020201Page.prototype.deleteDealProduct = function () {
        var self = this;
        swal({
            title: constants_1.Constants.BLANK,
    ...
    /*Get mst data*/
    SF003020201Page.prototype.assignMstDatas = function (data) {
    ...
    Object.defineProperty(SF003020201Page.prototype, "productType", {
        get: function () {
    ...
    Object.defineProperty(SF003020201Page.prototype, "isRequestDesign", {
        get: function () {
    ...
    // init data
    SF003020201Page.prototype.initDataMst = function () {
        var _this = this;
    ...
    SF003020201Page.prototype.parsePaperLamination = function (paper) {
    ...
    SF003020201Page.prototype.removeDataPaperTmp = function () {
    ...
    return SF003020201Page;
}(AbstractSF00302_page_1.AbstractSF00302Page));
exports.SF003020201Page = SF003020201Page;
//# sourceMappingURL=SF003020201.page.js.map