...
export class SF003020202Page extends AbstractSF00302Page<SF003020202Helper> implements AfterViewInit, OnInit {
    ...
    constructor(route: ActivatedRoute, router: Router, headerProvider: HeaderProvider, public sv00302Service: SF00302Service) {
        ...
        this.helper = new SF003020202Helper;
    ...
    get isDeleteEnable(): boolean {
        let isDeleteEnable: boolean = false;
        ...
        if (this.isCreat) {
            ...
            this.sv00302Service
                ...
                .then(data => {
                    ...
                    this.router
                        .navigate(['/home/deal', dealCode, 'product', productCode, 'carton-not-a'], {replaceUrl: true})
                        .then(res => {
    ...
    protected doDuplicateProduct(type: number): void {
        ...
        this.sv00302Service
            ...
            .then(data => {
                let productCode = data.dealProduct.product.productCode;
                this.router
                    .navigate(['/home/deal', this.pageData.dealCode, 'product', productCode,'carton-not-a'])
                    .then(res => {
