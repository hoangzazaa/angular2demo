...
export class SF0031003SearchPic implements AfterViewInit{
    ...
    constructor(public pageSerice: SF00310Service) {
        this.keySearchs = [];
    }
    ...
    changeDepartment(index: number) {
        ...
        if (this.keySearchs == undefined || this.keySearchs.length == 0) {
            ...
            let userPicSearch           = SF00310Helper.cloneUserModel(this.pageData.listPicSearch);
