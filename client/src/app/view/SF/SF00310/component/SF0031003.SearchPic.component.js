...
var SF0031003SearchPic = (function () {
    function SF0031003SearchPic(pageSerice) {
        this.pageSerice = pageSerice;
        this.emitSelectedPic = new core_1.EventEmitter();
        this.keySearchs = [];
    }
    SF0031003SearchPic.prototype.ngAfterViewInit = function () {
        // 2424
    ...
    Object.defineProperty(SF0031003SearchPic.prototype, "pageData", {
        get: function () {
    ...
    Object.defineProperty(SF0031003SearchPic.prototype, "departments", {
        get: function () {
    ...
    SF0031003SearchPic.prototype.onKeywordsChange = function (tags) {
        ...
        if (tags.length > 0) {
            ...
            this.pageData.listDepartmentScreen = SF00310_helper_1.SF00310Helper.cloneDepartmentModel(this.pageData.departments);
    ...
    SF0031003SearchPic.prototype.changeDepartment = function (index) {
        ...
        if (this.keySearchs == undefined || this.keySearchs.length == 0) {
            ...
            var userPicSearch = SF00310_helper_1.SF00310Helper.cloneUserModel(this.pageData.listPicSearch);
    ...
    SF0031003SearchPic.prototype.changeUser = function (index) {
    ...
    SF0031003SearchPic.prototype.closeModalUserPic = function () {
    ...
    SF0031003SearchPic.prototype.submitUserPic = function () {
    ...
    SF0031003SearchPic.prototype.disabledInputTag = function () {
        $('.tagsinput input').attr("readonly", "true");
    };
    SF0031003SearchPic.prototype.removeAllInputTag = function () {
        this.keySearchs = [];
    };
    // reset active list department
    SF0031003SearchPic.prototype.resetActiveDepartment = function () {
    ...
    SF0031003SearchPic.prototype.addAddressToGroups = function () {
        var _this = this;
    ...
    // add list sale
    SF0031003SearchPic.prototype.addListSale = function () {
        var _this = this;
        this.pageData.userPicModals = [];
        // get list user active
    ...
    SF0031003SearchPic.prototype.findIndexSale = function (key, list) {
        if (!!!list) {
            return -1;
        }
    ...
    ], SF0031003SearchPic.prototype, "emitSelectedPic", void 0);
    SF0031003SearchPic = __decorate([
        core_1.Component({
            selector: "[SF0031003]",
            templateUrl: "SF0031003.SearchPic.component.html"
        }), 
        __metadata('design:paramtypes', [SF00310_service_1.SF00310Service])
    ], SF0031003SearchPic);
    return SF0031003SearchPic;
}());
exports.SF0031003SearchPic = SF0031003SearchPic;
//# sourceMappingURL=SF0031003.SearchPic.component.js.map