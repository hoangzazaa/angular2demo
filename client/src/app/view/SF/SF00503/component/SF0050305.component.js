 ...
 */
var SF0050305Component = (function () {
    function SF0050305Component(sf00503Data, sf00503Service) {
    ...
    SF0050305Component.prototype.ngOnInit = function () {
        this.sf00503Data.calculatorCustomer();
    };
    SF0050305Component.prototype.addCustomerGoalNew = function () {
    ...
    // save customer goal
    SF0050305Component.prototype.saveCustomerGoal = function (itemEmit) {
        var _this = this;
        var message = "";
        ...
        this.sf00503Service.saveCustomerGoal(itemEmit.data).then(function (data) {
            // update item data
            _this.sf00503Data.customerGoalNews[itemEmit.index].id = data.customerGoal.id;
            _this.sf00503Data.customerGoalNews[itemEmit.index].goalItems = data.customerGoal.goalItems;
            _this.onCustomerGoalsSaved.emit();
            $.notify({ message: message }, { type: 'success' });
        });
    };
    // delete customer goal
    SF0050305Component.prototype.deleteCustomerGoal = function (itemEmit) {
        var self = this;
        swal({
            title: "",
            ...
            self.sf00503Service.deleteCustomerGoal(itemEmit.data.id).then(function (data) {
                if (itemEmit.data._hashCode) {
                    self.sf00503Data.customerGoalNews = $.grep(self.sf00503Data.customerGoalNews, function (customerGoal, index) {
                        return customerGoal._hashCode !== itemEmit.data._hashCode;
                    });
                    self.sf00503Data.customerGoalsYear = $.grep(self.sf00503Data.customerGoalsYear, function (customerGoal, index) {
                        return customerGoal._hashCode !== itemEmit.data._hashCode;
                    });
                }
                else {
    ...
    SF0050305Component.prototype.indexCustomerGoal = function (customerGoal) {
    ...
    SF0050305Component.prototype.emitCustomerGoalsDataChangedEvent = function () {
        this.onCustomerGoalsDataChanged.emit();
    };
    __decorate([
        core_1.Output(), 
        __metadata('design:type', core_1.EventEmitter)
    ], SF0050305Component.prototype, "onCustomerGoalsDataChanged", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', core_1.EventEmitter)
    ], SF0050305Component.prototype, "onCustomerGoalsAdded", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', core_1.EventEmitter)
    ], SF0050305Component.prototype, "onCustomerGoalsDeleted", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', core_1.EventEmitter)
    ], SF0050305Component.prototype, "onCustomerGoalsSaved", void 0);
    SF0050305Component = __decorate([
        core_1.Component({
            selector: "sf0050305",
    ...
    return SF0050305Component;
}());
exports.SF0050305Component = SF0050305Component;
//# sourceMappingURL=SF0050305.component.js.map