...
var Error500Page = (function (_super) {
    __extends(Error500Page, _super);
    function Error500Page(router, route) {
        _super.call(this, router, route);
    }
    Error500Page.prototype.back = function () {
        /*Back to Dashboard screen*/
        this.navigate(screen_url_1.ScreenUrl.SF001);
    };
    Error500Page = __decorate([
        core_1.Component({
...
//# sourceMappingURL=error-500.page.js.map