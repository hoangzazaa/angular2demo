...
/**
 * Created by TungNT on 23/03/2017.
 */
public class SF0020201_01 extends BaseData {
    ...
    String sqlUp() {
        return
                ...
                "DELETE FROM `sfr_sf_quotation_item` WHERE `deal_product_id` IN (SELECT id FROM `sfr_sf_deal_product` WHERE `deal_id`='9999');" +
                        ...
                        "INSERT INTO `sfr_sf_product` (`id`,`created_date`,`updated_date`,`product_name`,`product_code`,`paste_special_form_flag`,`special_size_flag`,`special_die_cutting_number_flag`,`paper_head_approval_flag`,`wooden_code`,`denno_product_code`) VALUES ('9999','2017-03-08 08:25:37','2017-03-08 08:25:37','ABC','P009999','0','1','0','0','V010111','12');" +
