...
import vn.vnext.sefuri.sf.json.core.OrderItemJson;
...
public class OrderJson extends BaseJson<OrderDto> {
	...
	private List<vn.vnext.sefuri.sf.json.core.OrderItemJson> orderItems;
	 ...
	 * @return orderItems
	 */
	public List<vn.vnext.sefuri.sf.json.core.OrderItemJson> getOrderItems(){
		return orderItems;
	}
