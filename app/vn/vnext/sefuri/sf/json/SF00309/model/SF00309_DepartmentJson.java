 ...
 */
public class SF00309_DepartmentJson {
    @JsonProperty("id")
    private Integer id;
    //department
    ...
    //departmentRsUser
    @JsonProperty("users")
    private List<SF00309_UserJson>users;
    ...
    public List<SF00309_UserJson> getUsers() {
        return users;
    }

    public void setUsers(List<SF00309_UserJson> users) {
        this.users = users;
    }
