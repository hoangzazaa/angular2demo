 ...
 */
public class SF00310_DepartmentJson {
    @JsonProperty("id")
    private Integer id;
    //department
    ...
    //departmentRsUser
    @JsonProperty("users")
    private List<SF00310_UserJson>users;
    ...
    public List<SF00310_UserJson> getUsers() {
        return users;
    }

    public void setUsers(List<SF00310_UserJson> users) {
        this.users = users;
    }
