...
public class ProductOutputJson  extends BaseJson<ProductOutputDto> {
    ...
    @JsonProperty("pasteStepWage")
    private BigDecimal pasteStepWage;

    @JsonProperty("laminationSize")
    ...
    @JsonProperty("cartonLotGap")
    private BigDecimal cartonLotGap;
    @JsonProperty("cartonSpecialFare")
    ...
    public void setData(ProductOutputDto dto){
        ...
        this.laminationSize = dto.getLaminationSize();
        this.pasteStepWage = dto.getPasteStepWage();
        ...
        this.cartonLotGap = dto.getCartonLotGap();
        this.cartonSpecialFare = dto.getCartonSpecialFare();
    }
    ...
    public ProductOutputDto getData(){
        ...
        dto.setPasteStepWage(pasteStepWage);
        dto.setLaminationSize(laminationSize);
        ...
        dto.setCartonLotGap(cartonLotGap);
        dto.setCartonSpecialFare(cartonSpecialFare);
        return dto;
    }
}
