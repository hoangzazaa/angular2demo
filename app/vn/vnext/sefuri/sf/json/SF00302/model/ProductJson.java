...
import vn.vnext.sefuri.sf.json.core.SupplierJson;
...
public class ProductJson extends BaseJson<ProductDto> {
    ...
    @JsonProperty("specialUpperFlapFlag")
    private Integer specialUpperFlapFlag;
    @JsonProperty("lowerFlap")
    private BigDecimal lowerFlap;
    @JsonProperty("specialLowerFlapFlag")
    private Integer specialLowerFlapFlag;
    @JsonProperty("bindingNumber")
    private Integer bindingNumber;
    @JsonProperty("stringColor")
    ...
    @JsonProperty("otherMethod1")
    private Integer otherMethod1;
    @JsonProperty("otherMethod2")
    private Integer otherMethod2;
    @JsonProperty("otherNote1")
    private String otherNote1;
    @JsonProperty("otherNote2")
    private String otherNote2;
    @JsonProperty("otherNote3")
    private String otherNote3;
    @JsonProperty("specialNote1Flag")
    private Integer specialNote1Flag;
    @JsonProperty("requiredAdditionalWork")
    ...
    @JsonProperty("foilColor1")
    private String foilColor1;
    @JsonProperty("foilColor2")
    private String foilColor2;
    @JsonProperty("foilColor3")
    private String foilColor3;
    @JsonProperty("packingInputNumber")
    private Integer packingInputNumber;
    @JsonProperty("passageNo")
    private String passageNo;
    @JsonProperty("packingNote")
    private String packingNote;
    @JsonProperty("dieCuttingFlag")
    private Integer dieCuttingFlag;
    @JsonProperty("stampingNumber")
    private Integer stampingNumber;
    @JsonProperty("shareWoodenFlag1")
    private Integer shareWoodenFlag1;
    @JsonProperty("shareWoodenFlag2")
    private Integer shareWoodenFlag2;

    /** バーコード1区分値 */
    @JsonProperty("specsBarcodeK1")
    private String specsBarcodeK1;
    /** バーコード2区分値 */
    @JsonProperty("specsBarcodeK2")
    private String specsBarcodeK2;
    /** バーコード3区分値 */
    @JsonProperty("specsBarcodeK3")
    private String specsBarcodeK3;
    /** バーコード1値 */
    @JsonProperty("specsBarcode1")
    private String specsBarcode1;
    /** バーコード2値 */
    @JsonProperty("specsBarcode2")
    private String specsBarcode2;
    /** バーコード3値 */
    @JsonProperty("specsBarcode3")
    ...
    public void setColorBText1(String colorBText) {
        this.colorBText1 = colorBText;
    }
    ...
    public void setDenno(Integer denno) {
        this.denno = denno;
    }
    ...
    public ProductDto getData() {
        ...
        dto.setBindingMethod(bindingMethod);
        dto.setHandPosition(handPosition);
        dto.setSpecialUpperFlapFlag(specialUpperFlapFlag);
        dto.setLowerFlap(lowerFlap);
        dto.setSpecialLowerFlapFlag(specialLowerFlapFlag);
        dto.setBindingNumber(bindingNumber);
        dto.setStringColor(stringColor);
        dto.setStringNumber(stringNumber);
        dto.setHandType(handType);
        dto.setHandSize(handSize);
        dto.setOtherMethod1(otherMethod1);
        dto.setOtherMethod2(otherMethod2);
        dto.setOtherNote1(otherNote1);
        dto.setOtherNote2(otherNote2);
        dto.setOtherNote3(otherNote3);
        dto.setSpecialNote1Flag(specialNote1Flag);
        ...
        dto.setFoilColor1(foilColor1);
        dto.setFoilColor2(foilColor2);
        dto.setFoilColor3(foilColor3);
        dto.setPackingInputNumber(packingInputNumber);
        dto.setPassageNo(passageNo);
        dto.setPackingNote(packingNote);
        dto.setDieCuttingFlag(dieCuttingFlag);
        dto.setStampingNumber(stampingNumber);
        dto.setWoodenCode2(woodenCode2);
        dto.setShareWoodenFlag1(shareWoodenFlag1);
        dto.setShareWoodenFlag2(shareWoodenFlag2);
        dto.setRequiredAdditionalWork(requiredAdditionalWork);
        dto.setSpecsBarcodeK1(specsBarcodeK1);
        dto.setSpecsBarcodeK2(specsBarcodeK2);
        dto.setSpecsBarcodeK3(specsBarcodeK3);
        dto.setSpecsBarcode1(specsBarcode1);
        dto.setSpecsBarcode2(specsBarcode2);
        dto.setSpecsBarcode3(specsBarcode3);
    ...
    public void setData(ProductDto dto) {
        ...
        this.bindingMethod = dto.getBindingMethod();
        this.handPosition = dto.getHandPosition();
        this.specialUpperFlapFlag = dto.getSpecialUpperFlapFlag();
        this.lowerFlap = dto.getLowerFlap();
        this.specialLowerFlapFlag = dto.getSpecialLowerFlapFlag();
        this.bindingNumber = dto.getBindingNumber();
        this.stringColor = dto.getStringColor();
        this.stringNumber = dto.getStringNumber();
        this.handType = dto.getHandType();
        this.handSize = dto.getHandSize();
        this.otherMethod1 = dto.getOtherMethod1();
        this.otherMethod2 = dto.getOtherMethod2();
        this.otherNote1 = dto.getOtherNote1();
        this.otherNote2 = dto.getOtherNote2();
        this.otherNote3 = dto.getOtherNote3();
        this.specialNote1Flag = dto.getSpecialNote1Flag();
        ...
        this.denno = dto.getDenno();
        this.sampleNo = dto.getSampleNo();
        this.foilColor1 = dto.getFoilColor1();
        this.foilColor2 = dto.getFoilColor2();
        this.foilColor3 = dto.getFoilColor3();
        this.packingInputNumber = dto.getPackingInputNumber();
        this.passageNo = dto.getPassageNo();
        this.packingNote = dto.getPackingNote();
        this.dieCuttingFlag = dto.getDieCuttingFlag();
        this.stampingNumber = dto.getStampingNumber();
        this.shareWoodenFlag1 = dto.getShareWoodenFlag1();
        this.shareWoodenFlag2 = dto.getShareWoodenFlag2();
        this.requiredAdditionalWork = dto.getRequiredAdditionalWork();
        this.specsBarcodeK1 = dto.getSpecsBarcodeK1();
        this.specsBarcodeK2 = dto.getSpecsBarcodeK2();
        this.specsBarcodeK3 = dto.getSpecsBarcodeK3();
        this.specsBarcode1 = dto.getSpecsBarcode1();
        this.specsBarcode2 = dto.getSpecsBarcode2();
        this.specsBarcode3 = dto.getSpecsBarcode3();
    }
}
